...
class OpenApiScenarioIntegrationTest extends FixtureAnyFunSuite with BeforeAndAfterAll with Matchers with FlinkSpec with LazyLogging with VeryPatientScalaFutures {
